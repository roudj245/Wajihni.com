...
function About(){
  ...
  <div className='About'>
    ...
    <div className='text5'>
        ...
        <p className='title4'>نحن هيئة علمية ثقافية تهدف إلى نشر العلم والمعرفة، وتعزيز القيم الإسلامية السامية في المجتمع. نسعى لبناء جيل واعٍ ومثقف من خلال المحاضرات، والندوات، والمبادرات التعليمية والتربوية. نؤمن بأن العلم هو السبيل إلى نهضة الأمة</p>
