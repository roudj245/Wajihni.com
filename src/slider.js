...
const data = [
  ...
  { img: tech, titre: 'المدرسة الوطنية العليا للتكنولوجيات المتقدمة' ,txt :'اكتشف مميزات هذا التخصص، مجالات العمل المتاحة، والمسارات الدراسية التي يمكنك اتباعها لتحقيق طموحاتك.'},
  ...
  { img: drone, titre: 'المدرسة الوطنية العليا للانظمة الذاتية ' ,txt :'اكتشف مميزات هذا التخصص، مجالات العمل المتاحة، والمسارات الدراسية التي يمكنك اتباعها لتحقيق طموحاتك.'},
  { img: nano, titre: 'المدرسة الوطنية العليا لعلوم النانو و تكنولوجيات النانو' ,txt :'اكتشف مميزات هذا التخصص، مجالات العمل المتاحة، والمسارات الدراسية التي يمكنك اتباعها لتحقيق طموحاتك.'},
  ...
  { img: commerce, titre: 'المدرسة العليا للتجارة' ,txt :'اكتشف مميزات هذا التخصص، مجالات العمل المتاحة، والمسارات الدراسية التي يمكنك اتباعها لتحقيق طموحاتك.'},
  { img: gestion, titre: 'المدرسة الوطنية العليا للتسيير و الاقتصاد الرقمي' ,txt :'اكتشف مميزات هذا التخصص، مجالات العمل المتاحة، والمسارات الدراسية التي يمكنك اتباعها لتحقيق طموحاتك.'},
  ...
  { img: france , titre: ' المدرسة العليا للأساتذة اللغة الفرنسية' ,txt :'اكتشف مميزات هذا التخصص، مجالات العمل المتاحة، والمسارات الدراسية التي يمكنك اتباعها لتحقيق طموحاتك.'},
  { img: bio , titre: ' المدرسة العليا للأساتذة علوم الطبيعة و الحياة' ,txt :'اكتشف مميزات هذا التخصص، مجالات العمل المتاحة، والمسارات الدراسية التي يمكنك اتباعها لتحقيق طموحاتك.'},
